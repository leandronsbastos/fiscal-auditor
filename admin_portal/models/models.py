"""
Modelos de banco de dados para o Portal Administrativo
Importa db de app_admin.py para evitar importação circular
"""
...
def create_models(db):
    """
    Cria e retorna os modelos usando a instância db do Flask-SQLAlchemy
    
    Args:
        db: Instância do SQLAlchemy do Flask
        
    Returns:
        dict: Dicionário com todas as classes de modelo
    """
